...
public class TimePickerHoraInicial extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        tvTitle.setText("Hora do Inicio do Evento");
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        Button btnHorario = (Button) getActivity().findViewById(R.id.btn_horario_inicio_evento_cadastro);
        String horaSelecionada = hourOfDay+":"+minute;
        SessionManager sessionManager = new SessionManager(getActivity().getBaseContext());
        sessionManager.setHorarioInicio(horaSelecionada);
